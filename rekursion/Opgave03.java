...
public class Opgave03 {
    public static void main(String[] args) {
        ...
        System.out.println("findHeltalIArray2(intArray,3) = " + findHeltalIArray2(intArray, 3));
    }
    ...
    public static boolean findHeltalIArray2(int[] array, int target){
        int low = 0;
        int high = array.length - 1;
        return findHeltalIArray2(array, target);
    }
